package com.byqj.module.dataKeepCollegeDepartment.enums;


import com.byqj.security.core.support.enums.IReasonOfFailure;

public enum DataKeepCollegeDepartmentReasonOfFailure implements IReasonOfFailure {
    ...
    DataKeepCollegeDepartmentReasonOfFailure(String en_msg, String zh_msg) {
        this.en_msg = en_msg;
        this.zh_msg = zh_msg;
    }
